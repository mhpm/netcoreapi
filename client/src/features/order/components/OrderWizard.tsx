      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          <div className="flex justify-between items-center relative z-10">
              ...
              return (
                ...
                >
                  <div
                    ...
                    ${isActive ? "bg-brand-orange text-white shadow-lg scale-110" : "bg-coffee-800 text-coffee-400 border border-white/5"}
                  ...
                  <span
                    className={`text-[10px] font-bold uppercase tracking-wider transition-colors duration-500 ${isActive ? "text-white" : "text-coffee-600"}`}
                  >
                    {step}
                  </span>
                </div>
            ...
            {/* Connector Line */}
            <div className="absolute top-5 left-[15%] right-[15%] h-0.5 bg-coffee-800 -z-10">
              <div
                className="h-full bg-brand-orange transition-all duration-700 ease-out"
                style={{
